...
], function(OpusWorldWind, WorldWind, BasicProgram, AbstractShape, Vec2, Vec3, Matrix, PickedObject, ScreenShapePlacemarkAttributes) {
    ...
    ScreenShapePlacemark.prototype._computeOutlineVertices = function() {
        ...
        if(points.length < 3) {
            ...
            for(var i = 0; i !== points.length - 1; ++i) {
                ...
                res.push(pi1[0]); res.push(pi1[1]);
                res.push(pi2[0]); res.push(pi2[1]);
                res.push(po1[0]); res.push(po1[1]);
                res.push(po2[0]); res.push(po2[1]);
                res.push(po1[0]); res.push(po1[1]);
                res.push(pi2[0]); res.push(pi2[1]);
            }
            return res;
